...
public final class HUD extends AbstractModule {
    ...
    private final StringProperty clientName = createString("Falls");
    @Property("scoreboard")
    ...
    private void drawUserInfo(Render2DEvent render2DEvent) {
        ...
        final String info = GRAY + build + GRAY + " | " + "UID - " + WHITE + "TIQS";
    ...
    private void drawName(Render2DEvent event) {
        ...
        String name = !clientName.isEmpty() ? clientName.charAt(0) + clientName.substring(1) : "F" + "alls";
